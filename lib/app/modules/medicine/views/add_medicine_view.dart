              ...
              Wrap(
                ...
                children: [
                  MealChip(
                    ...
                    isDark: isDark,
                    isSelected: mealRelation == 'Before Meal',
                    onSelected: (selected) {
                      if (selected) setState(() => mealRelation = 'Before Meal');
                    },
                  ),
                  MealChip(
                    label: 'After Meal',
                    ...
                    isDark: isDark,
                    isSelected: mealRelation == 'After Meal',
                    onSelected: (selected) {
                      if (selected) setState(() => mealRelation = 'After Meal');
                    },
                  ),
                  MealChip(
                    label: 'Empty Stomach',
                    ...
                    isDark: isDark,
                    isSelected: mealRelation == 'Empty Stomach',
                    onSelected: (selected) {
                      if (selected) setState(() => mealRelation = 'Empty Stomach');
                    },
                  ),
                  MealChip(
                    label: 'With Meal',
                    ...
                    isDark: isDark,
                    isSelected: mealRelation == 'With Meal',
                    onSelected: (selected) {
                      if (selected) setState(() => mealRelation = 'With Meal');
                    },
                  ),
                  MealChip(
                    label: 'Not Related',
                    ...
                    isDark: isDark,
                    isSelected: mealRelation == 'Not Related',
                    onSelected: (selected) {
                      if (selected) setState(() => mealRelation = 'Not Related');
                    },
                  ),
                ],
              ),
              ...
              Row(
                children: [
                  ScheduleTypeChip(
                    ...
                    isDark: isDark,
                    isSelected: selectedScheduleType == 'Daily',
                    onTap: () => setState(() => selectedScheduleType = 'Daily'),
                  ),
                  const SizedBox(width: 8),
                  ScheduleTypeChip(
                    label: 'Weekdays',
                    ...
                    isDark: isDark,
                    isSelected: selectedScheduleType == 'Weekdays',
                    onTap: () => setState(() => selectedScheduleType = 'Weekdays'),
                  ),
                  const SizedBox(width: 8),
                  ScheduleTypeChip(
                    label: 'Interval',
                    ...
                    isDark: isDark,
                    isSelected: selectedScheduleType == 'Interval',
                    onTap: () => setState(() => selectedScheduleType = 'Interval'),
                  ),
                ],
              ),
                ...
                Row(
                  ...
                  children: [
                    TimeSlotChip(
                      ...
                      isDark: isDark,
                      isSelected: reminderTimes.contains('Sokal'),
                      onTap: () => setState(() {
                        if (reminderTimes.contains('Sokal')) {
                          reminderTimes.remove('Sokal');
                        } else {
                          reminderTimes.add('Sokal');
                        }
                      }),
                    ),
                    TimeSlotChip(
                      ...
                      isDark: isDark,
                      isSelected: reminderTimes.contains('Dupur'),
                      onTap: () => setState(() {
                        if (reminderTimes.contains('Dupur')) {
                          reminderTimes.remove('Dupur');
                        } else {
                          reminderTimes.add('Dupur');
                        }
                      }),
                    ),
                    TimeSlotChip(
                      ...
                      isDark: isDark,
                      isSelected: reminderTimes.contains('Bikal'),
                      onTap: () => setState(() {
                        if (reminderTimes.contains('Bikal')) {
                          reminderTimes.remove('Bikal');
                        } else {
                          reminderTimes.add('Bikal');
                        }
                      }),
                    ),
                    TimeSlotChip(
                      ...
                      isDark: isDark,
                      isSelected: reminderTimes.contains('Rat'),
                      onTap: () => setState(() {
                        if (reminderTimes.contains('Rat')) {
                          reminderTimes.remove('Rat');
                        } else {
                          reminderTimes.add('Rat');
                        }
                      }),
                    ),
                  ],
