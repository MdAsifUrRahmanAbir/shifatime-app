...
class FullScreenAlarmBody extends GetView<MedicineController> {
  final DoseRecord dose;
  final Medicine? medicine;
  final Animation<double> pulseAnimation;

  const FullScreenAlarmBody({
    super.key,
    required this.dose,
                  ...
                  Expanded(
                    child: SizedBox(
                      ...
                      child: OutlinedButton.icon(
                        onPressed: () => showSnoozeBottomSheet(context, dose: dose, controller: controller),
